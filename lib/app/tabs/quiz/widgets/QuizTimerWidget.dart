...
class _QuizTimerWidgetState extends State<QuizTimerWidget> {
  ...
  onPressed: () async {
    ...
    if (quizCount >= 2) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => ChallengeThreeScreen()),
      );}
      else{
         showTopSnackbar(
        context,
...
void showTopSnackbar(BuildContext context, String message) {
  ...
  final overlayEntry = OverlayEntry(
    builder: (context) => Positioned(
      top: MediaQuery.of(context).padding.top + 10, // Status bar altında gösterim
      left: 10,
      right: 10,
      child: Material(
        ...
        children: [
          ...
          _isTimeUp
              ? ElevatedButton(
                  ...
                  child: Text("Katıl",style:TextStyle(fontSize: 14, color: Colors.white)),
                )
              : Text(
