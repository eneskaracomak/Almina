                  ...
                  children: <Widget>[
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        fontFamily:
                            'Allura', // Daha dekoratif bir font kullanabilirsiniz
                      ),
                    ),
                    Stack(
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) => ProductListPage(
                                    categoryName: option
                                        .name, // Ürünü detay sayfasına gönderiyoruz
                                  ),
                                ),
                              );
                            },
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  ...
                                  blurRadius: 5,
                                  offset: Offset(0,
                                      3), // değişen offset ile biraz derinlik ekledik
                                ),
                              ],
                            ),
                            child: Row(
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        currentOrder
                                            .date, // Order'ın tarihini gösteriyoruz
                                        style: TextStyle(
                                            fontSize: 14.0,
                                            color: Colors.grey[600]),
                                      ),
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius:
              BorderRadius.circular(15), // Her köşe için border radius
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              Image.network(
                  "https://cdn-icons-png.flaticon.com/512/5659/5659825.png"),
              SizedBox(width: 1),
              Text(
                "Şanslı Çark",
                style: TextStyle(
...
class _BenimMasamBannerState extends State<BenimMasamBanner> {
          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  Image.network(
                      "https://cdn-icons-png.flaticon.com/512/1187/1187436.png"),
                  SizedBox(width: 6),
                  Text(
  ...
  void _showCustomMasaInfoDialog(
      BuildContext context, FirebaseService service) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return Dialog(
          shape: RoundedRectangleBorder(
            borderRadius:
                BorderRadius.circular(24), // Daha modern köşe yuvarlama
          ),
          elevation: 15,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GridView.count(
                      ...
                      crossAxisSpacing: 12,
                      childAspectRatio:
                          2.5, // Butonların genişlik-yükseklik oranı
                      children: [
                        _buildActionButton(
                          context,
                          'Garson Çağır',
          ...
          Expanded(
            ...
            child: FittedBox(
              ...
              child: Column(
                ...
                children: <Widget>[
                  if (result != null) Text('${result!.code}'),
                ],
              ),
            ),
          ),
